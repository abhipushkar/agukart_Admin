...
const ComposeChatBoxAdmin = ({ slug, role }) => {
    ...
    if (input.trim() || file) {
      ...
      if (matchingDocument) {
        ...
        if (file) {
          ...
          // Await the upload task and get download URL
        ...
        console.log(updateRese, "Updated document with new message array.");
      }
      setInput("");
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        <List>
          {messages.map((msg, index) => {
            ...
            console.log(msg, "sbse bdi hdhdhdhdhdhdhdh");
            ...
            return (
              ...
              >
                {showDate && (
                  <Typography fontSize={13} color={"gray"} textAlign={"center"} pb={1}>
                    {currentMessageDate}
                  </Typography>
                )}
                <Box
                ...
                >
                  ...
                  <div>
                    ...
                    {
                      Object.keys(msg?.productData || {}).length > 0 && <Box
                        sx={{
                          display: "flex",
                          alignItems: "center",
                          gap: 2,
      ...
      <Box sx={{ boxShadow: "0 -10px 18px -10px #0e0e0e2e", background: "#fff" }} p={2}>
