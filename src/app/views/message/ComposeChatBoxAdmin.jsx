import { Box, Button, Checkbox, FormControlLabel, Link, List, Radio, RadioGroup, Switch, TextareaAutosize, TextField, ToggleButton, Tooltip, Typography, IconButton, Paper, Avatar, Card, Stack, useTheme, useMediaQuery } from "@mui/material";
      ...
      {!loadingAudience && matchingDoc?.some((m) => m?.type !== "allvendors") && (
        ...
        >
          ...
          <Box sx={{
            ...
            <FormControlLabel
              control={<Switch checked={stopSpreading} onChange={handleSpreading} size="small" />}
              label={<Typography fontSize={13}>Stop Message Spread</Typography>}
...
export default ComposeChatBoxAdmin;