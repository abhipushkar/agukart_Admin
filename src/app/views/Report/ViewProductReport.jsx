    ...
    <Box sx={{ margin: "30px" }}>
      ...
      >
        <Breadcrumb
          routeSegments={[
            { name: "Report", path: "" },
            { name: "Product Report", path: `${ROUTE_CONSTANT.report.productReport}` },
          ...
          <CardContent>
            {reportData?.type == "ip" ? (
              <>
                ...
                <Grid container spacing={3} sx={{ marginTop: "6px" }}>
                  <Grid item xs={12} md={8}>
                    <div style={{ marginBottom: "6px" }}>
                      Product ID :{" "}
                      <Typography variant="span">{reportData?.productdetail?._id}</Typography>
                    </div>
                    <div style={{ marginBottom: "6px" }}>
                      Shop Name :{" "}
                      <Typography variant="span">
                        {reportData?.productdetail?.shopdata?.shop_name}
                      </Typography>
                    </div>
                    <div style={{ marginBottom: "6px" }}>
                      Product Title :{" "}
                      <Typography variant="span">
                        {reportData?.productdetail?.product_title?.replace(/<\/?[^>]+(>|$)/g, "")}
                      </Typography>
                    </div>
                    <div style={{ marginBottom: "6px" }}>
                      Product URL :{" "}
                  ...
                  <Grid item xs={12} md={4}>
                    <Typography sx={{ textAlign: "center" }}>Product Images</Typography>
                    <div style={{ width: "300px" }}>
                      <img
                        src={`${productBaseUrl}${reportData?.productdetail?.image?.[0]}`}
              ...
              <>
                <DetailItem
                  label="Product Name"
                  value={removeHTMLTags(reportData?.productdetail?.product_title || "")}
                />
