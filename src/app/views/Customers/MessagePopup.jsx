    ...
    if (input.trim() || files.length > 0) {
      ...
      if (matchingDocument) {
        ...
        await addDoc(collection(db, "chatRooms"), {
          ...
          isDeleted: false,
          currentTime: new Date(),
          userName: userDetailForChat.name,
          vendorName: "Admin" || "",
          productId: null,
          orderId: null,
        });
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Typography component="div">
                <img
                  src={userDetailForChat.image ? `${userDetailForChat.image}` : "https://i.etsystatic.com/isla/24ec0e/34844512/isla_75x75.34844512_ke6bg9xj.jpg?version=0"}
                  style={{
                    borderRadius: "4px",
                    width: "40px",
                    height: "40px",
